...
Before beginning, ensure you have an osmosis node running in the background of the same machine you intend to relay on. Follow [this guide](./) or [use the Osmosis installer](https://get.osmosis.zone) to set up an Osmosis node if you have not already.
