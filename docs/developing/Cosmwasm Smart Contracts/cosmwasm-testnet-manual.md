...
::: tip
Please note this a detailed guide on how to deploy via `osmosisd`, it also covers additional tooling and useful tips.  You can also deploy to testnet with [Beaker](https://github.com/osmosis-labs/beaker) with a couple of commands. 
:::
