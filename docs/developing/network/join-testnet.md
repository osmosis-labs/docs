...
Make sure you have [installed the Osmosis Binary (CLI)](../../developing/osmosis-core/osmosisd.md#manual-installation) prior to following the below instructions.

You may also [use the Osmosis installer](../../developing/osmosis-core/osmosisd.md#quick-start) if you want everything to be done automatically.
