...
Per-pair overrides, managed by the [Protocol Fee Controller](https://daodao.zone/dao/osmo162wk8qc3w5s9hfs8dm76wrqnk6fjmsez2t4kk6zyugmrlzgds8sqfesmlm) subDAO, adjust this in both directions: major routes are reduced (for example, allBTC/USDC pays 0.02%), while OSMO pairs are raised to between 0.5% and 0.8% (for example, OSMO/USDC pays 0.8%).
