...
There is a dedicated testnet for Concentrated liquidity.

### Endpoints

- RPC Endpoint: `https://rpc.clnet.dev-osmosis.zone/`
- LCD Endpoint: `https://lcd.clnet.dev-osmosis.zone/`

### Chain Information

- Chain ID: `clnet`

Please use this network instead of the edgenet to perform testing. It is similar to edgenet but includes some simplifications for clnet testing.
