...
- [Vote](https://github.com/hyperweb-io/cosmos-kit/blob/main/packages/example/pages/gov.tsx)
...
- [@cosmos-kit/example](https://github.com/hyperweb-io/cosmos-kit/blob/main/packages/example): An example Next.js project integrating `@cosmos-kit/react` wallet adapter.
