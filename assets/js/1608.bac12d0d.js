...
const DyteJoinStage = class {
  constructor(hostRef) {
    ...
    this.joinState = () => {
      this.meeting.self.joinStage();
      this.stateUpdate.emit({ activeJoinStage: false });
    };
    this.leaveStage = () => {
      this.meeting.self.leaveStage();
      this.stateUpdate.emit({ activeJoinStage: false });
    };
  }
  render() {
    ...
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t('stage.join_title'))), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_330fca84_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-participant-setup", defaults: defaults, props: { participant: (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.self, size: 'md' }, childProps: { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, size: 'md' }, deepProps: true }), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "summary" }, this.t('stage.join_summary')), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "container" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "danger", onClick: this.leaveStage, title: this.t('stage.join_cancel') }, this.t('stage.join_cancel')), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { onClick: this.joinState, title: this.t('stage.join_confirm') }, this.t('stage.join_confirm')))));
  }
};
