...
const DytePollsToggle = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      ...
      this.meeting.polls.on('pollsUpdate', this.onPollsUpdate);
    }
  }
  statesChanged(s) {
  ...
  togglePollsTab() {
    ...
    _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.pollsActive;
    _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.pollsActive ? 'polls' : 'none';
  }
  render() {
    var _a;
    ...
    if ((0,_versionTwoApis_04d51844_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.meeting.self.suggestedTheme) ||
      (((_a = this.meeting) === null || _a === void 0 ? void 0 : _a.self.suggestedTheme) &&
        !this.meeting.self.suggestedTheme.controlBar.elements.polls))
      return;
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, this.unreadPollsCount !== 0 && !this.pollsActive && ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unread-count", part: "unread-count" }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.unreadPollsCount <= 100 ? this.unreadPollsCount : '99+'))), (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.pollsActive }, onClick: () => this.togglePollsTab(), icon: this.iconPack.poll, label: text, variant: this.variant })));
  }
