...
const DyteSettingsToggle = class {
  ...
  toggleSettings() {
    var _a;
    this.stateUpdate.emit({ activeSettings: !((_a = this.states) === null || _a === void 0 ? void 0 : _a.activeSettings) });
    _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings = !_store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings;
  }
  render() {
    const text = this.t('settings');
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: () => this.toggleSettings(), icon: this.iconPack.settings, label: text, variant: this.variant })));
  }
};
