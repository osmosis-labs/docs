...
const dyteCameraToggleCss = ":host{display:block;font-family:var(--dyte-font-family, sans-serif)}";
...
const DyteCameraToggle = class {
  ...
  updateCanProduce(meeting) {
    ...
    const hasPermission = (0,_versionTwoApis_04d51844_js__WEBPACK_IMPORTED_MODULE_4__.c)(_versionTwoApis_04d51844_js__WEBPACK_IMPORTED_MODULE_4__.P.Video, self.permissions);
  ...
  hasPermissionError() {
    return this.cameraPermission !== 'NOT_REQUESTED' && this.cameraPermission !== 'ACCEPTED';
  }
  getState() {
    let tooltipLabel = '';
    let label = '';
    ...
    if (this.cameraPermission === 'COULD_NOT_START') {
      tooltipLabel = this.t('Unable to start camera');
    }
      ...
      tooltipLabel = this.videoEnabled ? this.t('Disable Camera') : this.t('Enable Camera');
    }
