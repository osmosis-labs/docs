...
const DyteTextField = class {
  ...
  connectedCallback() {
    ...
    _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_1__.s.abc = false;
  }
  get value() {
    return this.input.value;
  }
  render() {
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { ref: (el) => (this.input = el), type: this.type, placeholder: this.placeholder, disabled: this.disabled })));
  }
};
