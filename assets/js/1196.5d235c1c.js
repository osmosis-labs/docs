...
const dyteMoreToggleCss = ":host{display:block;font-family:var(--dyte-font-family, sans-serif)}";
...
const DyteMoreToggle = class {
  constructor(hostRef) {
    ...
    this.toggleMoreMenu = () => {
      ...
      this.stateUpdate.emit({ activeMoreMenu: this.isOpen });
      _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = this.isOpen;
    };
  }
  render() {
    const text = this.t('More');
    const states = this.states || _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s;
    const icon = (states === null || states === void 0 ? void 0 : states.activeMoreMenu) === true ? this.iconPack.chevron_down : this.iconPack.chevron_up;
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, onClick: () => this.toggleMoreMenu(), icon: icon, label: text, part: "controlbar-button" })));
  }
};
