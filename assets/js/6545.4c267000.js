...
const DyteBreakoutRoomsToggle = class {
  constructor(hostRef) {
    ...
    this.breakoutRoomToggle = () => {
      ...
      if (this.states.activeBreakoutRooms || activeConnectedMeetings > 0) {
        ...
        _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomGrid = !_store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomGrid;
      }
      else {
        ...
        _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager = {
          active: !((_e = _store_87c9fa78_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager) === null || _e === void 0 ? void 0 : _e.active),
          mode: 'create',
        };
      }
    };
  ...
  render() {
    ...
    if (!(permissions === null || permissions === void 0 ? void 0 : permissions.canAlterConnectedMeetings) && !this.states.activeBreakoutRooms)
      return;
    return ((0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('Breakout Rooms') }, (0,_index_9f89d2b2_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: this.breakoutRoomToggle, class: { active: this.states.activeBreakoutRooms && this.states.activeBreakoutRoomGrid }, icon: this.iconPack.breakout_rooms, label: this.t('Breakout Rooms'), variant: this.variant })));
  }
};
